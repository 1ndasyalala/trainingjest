...
describe("Capitalize", () => {
  ...
  test('Case 2: Capitalize entire string', () => {
    const result = capitalize('this is a test');
    expect(result).toBe('This is a test');
  });

  test('Case 3: Empty string should return empty string', () => {
    const result = capitalize('');
    expect(result).toBe('');
  });

  test('Case 4: Non-alphabetic characters should not be affected', () => {
 ...
 */
  ...
  describe("EpochDateToUTC", () => {
    ...
    // write another 3 test case here!// Write ur test-code here!
